...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container text-light bg-dark text-center">
        <div>
            <h1>
              <br> Registrar venta</h1>
        </div>

        <!-- Inicio del formulario-->

        <!-- CLIENTE -->
        <form class="bg-dark" action="procesaVen.php" method="POST" enctype="multipart/form-data">
        <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <input class="form-control" type="text" class="form-control" name="cantidad" id="cantidad" placeholder="Ingresa la cantidad a vender">
            </div>
