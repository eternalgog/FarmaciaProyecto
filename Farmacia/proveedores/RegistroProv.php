...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container text-light bg-dark text-center">
        <div>
            <h1>
              <br> Registrar proveedor</h1>
        </div>

        <!-- Inicio del formulario-->

        <form class="bg-dark" action="procesaProv.php" method="POST" enctype="multipart/form-data">
            <div class="form-group mb-3">
              <label for="nombre" >Nombre del proveedor</label>
              <input class="form-control" type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingresa el nombre del proveedor">
            </div>
            <div class="form-group mb-3">
              <label for="uso" >Telefono</label>
              <input class="form-control" type="text" class="form-control" name="tlf" id="tlf" placeholder="Ingresa el numero de teléfono del proveedor">
            </div>
