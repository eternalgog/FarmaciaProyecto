...
<body>
  ...
  <?php
    ...
    $sql = "SELECT * FROM medicamentos WHERE medicamentos.nombre='$busqueda'";
    ...
    if($result->num_rows){
      while($row = mysqli_fetch_assoc($result)){
        ...
        <td><a href='borrar.php?id=$id'> <img width='50px' height='auto' src='borrador.png'></img></a></td>
        </tr> </table>
        ";
      }
    }else{
      echo "<div class='container text-light bg-dark text-center'> <br><p>Medicamento '$busqueda' no encontrado.</p> <br></div>";
    }
