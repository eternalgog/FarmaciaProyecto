...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="container text-light bg-dark text-center">
        <div>
            <h1>
              <br> Modificar proovedor</h1>
        </div>

        <!-- Inicio del formulario-->
        <form class="bg-dark" action="procesaEdit.php" method="POST" enctype="multipart/form-data">
        <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <input class="form-control" type="text" class="form-control" name="tlf" id="tlf" placeholder="Ingresa la utilización del medicamento">
            </div>             
