...
<body>
  ...
  <tr>
    ...
    while($row = mysqli_fetch_assoc($result)){
      ...
      <td>$nombre</td>
      <td>$tlf</td>
      <td><a href='editarCli.php?id=$id'> <img width='50px' height='auto' src='lapiz.png'></img></a></td>
      <td><a href='eliminarCli.php?id=$id'> <img width='50px' height='auto' src='borrador.png'></img></a></td>
      </tr>
      ";
    ...
    echo "<div class='container text-light bg-dark text-center'> <br><p>No hay clientes registrados.</p> <br></div>";
    }
  ?>
