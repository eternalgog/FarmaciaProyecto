    ...
    <div class="container text-light bg-dark text-center">
        ...
        <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
              ...
              <input class="form-control" type="text" class="form-control" name="precio" id="precio" readonly>
            </div>             
